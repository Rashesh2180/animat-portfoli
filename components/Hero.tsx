        ...
        >
          <div className="flex items-center justify-center gap-4 md:gap-8 mb-2 flex-wrap">
            ...
            <motion.span
              ...
              className="px-6 py-2 md:py-4 bg-neon-yellow text-black rounded-full  relative overflow-hidden flex items-center"
              ...
              >
                ...
                <div className="flex w-1/2 justify-around">
                  <span className="whitespace-nowrap font-bold flex items-center gap-2 md:gap-4 px-4 text-4xl md:text-5xl lg:text-7xl">
                    <span className="text-3xl md:text-4xl lg:text-6xl mr-3">✦</span> hello
                  </span>
                  <span className="whitespace-nowrap font-bold flex items-center gap-2 md:gap-4 px-4 text-4xl md:text-5xl lg:text-7xl">
                    <span className="text-3xl md:text-4xl lg:text-6xl mr-3">✦</span> hello
                  </span>
          ...
          <div className="text-white mt-2 sm:mb-10">Motivala</div>
        </motion.h1>
      </div>
        ...
        <div className="border-t border-dashed border-white/20 pt-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <motion.div
              ...
              className="text-center text-gray-300 text-lg max-w-2xl mx-auto col-span-1 md:col-start-2 mt-12 md:mt-16 leading-relaxed"
            >
              <p className="mt-10">I am front end developer.</p>
              <p>
                I design with pixel-perfect common class practices, responsive layouts, and animations.
                For development, I work with role-based routing, reusable components, and SEO performance-improved code.
              </p>
            </motion.div>
